...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0"><img class="masthead-avatar mb-5" src="<?php echo base_url('assets/user') ?>/img/logo.png" alt="">Puskesmas Nusantara</h1>
      <div class="row">
      ...
      <?php } ?>
      <?php if(empty($this->session->userdata('id_pasien'))){ ?>
        <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di Puskesmas Nusantara. 
    ...
    <div class="container-fluid">  
      <div class="row">
        <div class="col-lg-4.ml-auto" align="center">
          ...
          <p class="legend">Pasien melakukan Registrasi > Input Nomor Identitas, Nama Pasien, Jenis Kelamin, Usia, Tanggal Lahir, Alamat, Nomor Telephone, Username dan Password > Klik Login >  Pilih Poli > Klik Cetak </p>
      </div>
    </div>
    </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small> Antrian Puskesmas Nusantara </small>
    </div>
  </section>
